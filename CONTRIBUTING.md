Contributing to Btcavenue Core
============================

The Btcavenue Core project operates an open contributor model where anyone is
...
[good first issue](https://github.com/btcavenue/btcavenue/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or participate in a weekly [Btcavenue Core PR Review Club](https://btcavenuecore.reviews/) meeting.

Communication Channels
----------------------

Most communication about Btcavenue Core development happens on IRC, in the
#btcavenue-core-dev channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/btcavenue-core-dev/](http://www.erisian.com.au/btcavenue-core-dev/)
and [http://gnusha.org/btcavenue-core-dev/](http://gnusha.org/btcavenue-core-dev/).

Discussion about code base improvements happens in GitHub issues and on pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/btcavenue-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to btcavenue-qt
...
[Translation Process](https://github.com/btcavenue/btcavenue/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Btcavenue Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Btcavenue
Network Protocol consensus changes.

Whether a pull request is merged into Btcavenue Core rests with the project merge
...
Patches that change Btcavenue consensus rules are considerably more involved than
...
Where a patch set proposes to change the Btcavenue consensus, it must have been
...
https://github.com/btcavenue/btcavenue/pull/16189).

Also see the [backport.py script](
https://github.com/btcavenue-core/btcavenue-maintainer-tools#backport).

Release Policy
--------------

The project leader is the release manager for each Btcavenue Core release.
