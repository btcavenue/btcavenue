...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the btcavenue repository."
  exit 1
fi
...
# See https://github.com/btcavenue/btcavenue/issues/16064
...
echo 'When compiling btcavenued, run `./configure` in the following way:'
echo
