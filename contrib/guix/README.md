# Bootstrappable Btcavenue Core Builds

This directory contains the files necessary to perform bootstrappable Btcavenue
Core builds.
...
- 24GB of free disk space on the partition that the Btcavenue Core git repository
  resides in
...
For a Btcavenue Core depends development environment, simply invoke
...
From the top of a clean Btcavenue Core repository:
...
To use dongcarl's substitute server for Btcavenue Core builds after having
