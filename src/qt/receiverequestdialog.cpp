...
#include <config/btcavenue-config.h> /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatBtcavenueURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + BtcavenueUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatBtcavenueURI(info));
}
