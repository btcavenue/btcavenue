    ...
    mapper(nullptr)
{
    ...
    ui->btcavenueAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->btcavenueAtStartup);
    ...
    ui->btcavenueAtStartup->setToolTip(ui->btcavenueAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->btcavenueAtStartup->setText(ui->btcavenueAtStartup->text().arg(PACKAGE_NAME));

    ui->openBtcavenueConfButton->setToolTip(ui->openBtcavenueConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BtcavenueUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->btcavenueAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBtcavenueConfButton_clicked()
{
