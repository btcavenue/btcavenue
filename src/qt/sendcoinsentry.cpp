    ...
    platformStyle(_platformStyle)
{
    ...
    // normal btcavenue address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying btcavenue address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &BtcavenueAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
