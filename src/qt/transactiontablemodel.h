...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, BtcavenueUnits::SeparatorStyle separators=BtcavenueUnits::separatorStandard) const;
