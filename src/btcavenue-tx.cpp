...
static void SetupBtcavenueTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " btcavenue-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  btcavenue-tx [options] <hex-tx> [commands]  Update hex-encoded btcavenue transaction\n" +
            "or:     btcavenue-tx [options] -create [commands]   Create hex-encoded btcavenue transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded btcavenue transaction
