// Copyright (c) 2019 The Btcavenue Core developers
...
/* A AEAD class for ChaCha20-Poly1305@btcavenue.
 *
 ...
 *
 * The chacha20-poly1305@btcavenue combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@btcavenue cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@btcavenue are relatively fast in
