 ...
 *  A CTxDestination is the internal data type encoded in a btcavenue address
 */
...
/**
 * Generate a Btcavenue scriptPubKey for the given CTxDestination. Returns a P2PKH
