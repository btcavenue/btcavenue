...
static std::vector<RPCResult> MempoolEntryDescription() { return {
    ...
    RPCResult{RPCResult::Type::NUM, "size", "(DEPRECATED) same as vsize. Only returned if btcavenued is started with -deprecatedrpc=size\n"
                        ...
                        {RPCResult::Type::OBJ, "scriptPubKey", "",
                            {
                                ...
                                {RPCResult::Type::ARR, "addresses", "array of btcavenue addresses",
...
UniValue dumptxoutset(const JSONRPCRequest& request)
{
...

    {
        ...
        //
        // See discussion here:
        //   https://github.com/btcavenue/btcavenue/pull/15606#discussion_r274479369
        //
        LOCK(::cs_main);
