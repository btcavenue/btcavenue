...
class ListSinceBlockTest(BtcavenueTestFramework):
    ...
    def test_double_spend(self):
        ...
        1. User 1 receives BTAV in tx1 from utxo1 in block aa1.
        2. User 2 receives BTAV in tx2 from utxo1 (same) in block bb1
