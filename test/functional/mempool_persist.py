...
By default, btcavenued will dump mempool on shutdown and
...
class MempoolPersistTest(BtcavenueTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent btcavenued from writing mempool.dat to disk. Verify that `savemempool` fails")
