#!/usr/bin/env python3
# Copyright (c) 2018-2020 The Btcavenue Core developers
...
class AvoidReuseTest(BtcavenueTestFramework):
    ...
    def test_fund_send_fund_senddirty(self):
        '''
        Test the same as test_fund_send_fund_send, except send the 10 BTAV with
        the avoid_reuse flag set to false. This means the 10 BTAV send should succeed,
    ...
    def test_fund_send_fund_send(self, second_addr_type):
        ...
        [0] sends 10 BTAV to A.
        [1] spends 5 BTAV from A. (leaving roughly 5 BTAV useable)
        [0] sends 10 BTAV to A again.
        [1] tries to spend 10 BTAV (fails; dirty).
        [1] tries to spend 4 BTAV (succeeds; change address sufficient)
        '''
