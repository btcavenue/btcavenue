...
class WalletTest(BtcavenueTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 BTAV from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 BTAV with subtract fee from amount
        ...
        # Sendmany 10 BTAV with subtract fee from amount
        ...
        # This will raise an exception for attempting to get the private key of an invalid Btcavenue address
        assert_raises_rpc_error(-5, "Invalid Btcavenue address", self.nodes[0].dumpprivkey, "invalid")

        # This will raise an exception for attempting to set a label for an invalid Btcavenue address
        assert_raises_rpc_error(-5, "Invalid Btcavenue address", self.nodes[0].setlabel, "invalid address", "label")

        # This will raise an exception for importing an invalid address
        assert_raises_rpc_error(-5, "Invalid Btcavenue address or script", self.nodes[0].importaddress, "invalid")
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/btcavenue/btcavenue/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
