...
class RawTransactionsTest(BtcavenueTestFramework):
    ...
    def test_invalid_change_address(self):
        ...
        assert_raises_rpc_error(-5, "changeAddress must be a valid btcavenue address", self.nodes[2].fundrawtransaction, rawtx, {'changeAddress':'foobar'})
