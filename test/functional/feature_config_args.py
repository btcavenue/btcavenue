#!/usr/bin/env python3
# Copyright (c) 2017-2020 The Btcavenue Core developers
...
class ConfArgsTest(BtcavenueTestFramework):
    ...
    def test_config_file_parser(self):
        ...
        with open(os.path.join(self.nodes[0].datadir, 'btcavenue.conf'), 'a', encoding='utf-8') as conf:
    ...
    def run_test(self):
        ...
        conf_file = os.path.join(default_data_dir, "btcavenue.conf")
