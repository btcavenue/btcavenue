...
"""Verify that starting btcavenue with -h works as expected."""

from test_framework.test_framework import BtcavenueTestFramework
from test_framework.util import assert_equal

class HelpTest(BtcavenueTestFramework):
    ...
    def run_test(self):
        self.log.info("Start btcavenue with -h for help text")
        ...
        self.log.info("Start btcavenue with -version for version information")
        ...
        self.log.info("Start btcavenued with -fakearg to make sure it does not start")
