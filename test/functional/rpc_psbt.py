...
class PSBTTest(BtcavenueTestFramework):
    ...
    def run_test(self):
        # Create and fund a raw tx for sending 10 BTAV
        ...
        # feeRate of 0.1 BTAV / KB produces a total fee slightly below -maxtxfee (~0.05280000):
        ...
        # feeRate of 10 BTAV / KB produces a total fee well above -maxtxfee
