...
class TestShell:
    """Wrapper Class for BtcavenueTestFramework.

    The TestShell class extends the BtcavenueTestFramework
    ...
    class __TestShell(BtcavenueTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BtcavenueTestFramework child class.
            self.num_nodes = 1
