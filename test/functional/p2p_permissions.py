...
class P2PPermissionsTests(BtcavenueTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].btcavenueconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].btcavenueconf, 'w', encoding="utf8") as f:
            f.write(newText)
