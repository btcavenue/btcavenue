...
```
git clone https://github.com/btcavenue-core/qa-assets
...
To build Btcavenue Core using AFL instrumentation (this assumes that the
...
with certain assembly code from Btcavenue Core's code. See [developer notes on sanitizers](https://github.com/btcavenue/btcavenue/blob/master/doc/developer-notes.md#sanitizers)
