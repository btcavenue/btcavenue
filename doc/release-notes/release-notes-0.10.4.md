Btcavenue Core version 0.10.4 is now available from:

  <https://btcavenue.org/bin/btcavenue-core-0.10.4/>
...
- #6953 `43c2789` Split btcavenue-tx into its own package
- #6953 `dfe0d4d` Include btcavenue-tx binary on Debian/Ubuntu
