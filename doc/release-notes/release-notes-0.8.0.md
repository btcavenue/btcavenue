Btcavenue-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/btcavenue/files/Btcavenue/btcavenue-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Btcavenue
...
New/changed settings (command-line or btcavenue.conf file)
--------------------------------------------------------
