Btcavenue version 0.5.4 is now available for download at:
http://sourceforge.net/projects/btcavenue/files/Btcavenue/btcavenue-0.5.4/
...
http://gitorious.org/btcavenue/btcavenued-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Btcavenue-Qt notifications under Growl 1.3.
Increase required age of Btcavenue-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBtcavenue properly when installing Btcavenue-Qt over it. (Windows)
