Btcavenue Core version 0.9.2.1 is now available from:

  https://btcavenue.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BTAV to 0.01 BTAV
...
- Fix "Start btcavenue on system login"
