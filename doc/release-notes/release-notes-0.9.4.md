Btcavenue Core version 0.9.4 is now available from:

  https://btcavenue.org/bin/0.9.4/
...
this update is incompatible with the Btcavenue system and could lead to consensus
forks.

Btcavenue Core released binaries from https://btcavenue.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~btcavenue/+archive/ubuntu/btcavenue
- A third-party or self-compiled Btcavenue Core

upgrade to Btcavenue Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
