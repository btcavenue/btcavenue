...
Btcavenue Core version 0.19.1 is now available from:

  <https://btcavenuecore.org/bin/btcavenue-core-0.19.1/>
...
From Btcavenue Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Btcavenue Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Btcavenue Core does not yet change appearance when
...
- #17488 fix "btcavenued already running" warnings on macOS (fanquake)
