Download URL: https://sourceforge.net/projects/btcavenue/files/Btcavenue/btcavenue-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BTAV fee schedule (users still pay 0.01 BTAV per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #btcavenue00 - #btcavenue99
