Btcavenue Core version 0.16.1 is now available from:

  <https://btcavenuecore.org/bin/btcavenue-core-0.16.1/>
...
- #12843 `df38b13` Test starting btcavenued with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure btcavenued processes are cleaned up when tests end (sdaftuar)
