Btcavenue Core version 0.13.2 is now available from:

  <https://btcavenue.org/bin/btcavenue-core-0.13.2/>
...
- #8908 `4a974b2` Update btcavenue-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow btcavenue-tx to create v2 transactions (btcdrak)
