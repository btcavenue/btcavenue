*After branching off for a major version release of Btcavenue Core, use this
...
https://github.com/btcavenue-core/btcavenue-devwiki/wiki/
...
Btcavenue Core version *version* is now available from:

  <https://btcavenuecore.org/bin/btcavenue-core-*version*/>
...
From Btcavenue Core 0.20.0 onwards, macOS versions earlier than 10.12 are no
longer supported. Additionally, Btcavenue Core does not yet change appearance
...
#### Removal of reject network messages from Btcavenue Core (BIP61)

The command line option to enable BIP61 (`-enablebip61`) has been removed.

This feature has been disabled by default since Btcavenue Core version 0.18.0.
Nodes on the network can not generally be trusted to send valid ("reject")
messages, so this should only ever be used when connected to a trusted node.
Please use the recommended alternatives if you rely on this deprecated feature:

* Testing or debugging of implementations of the Btcavenue P2P network protocol
  should be done by inspecting the log messages that are produced by a recent
  version of Btcavenue Core. Btcavenue Core logs debug messages
...
- `testmempoolaccept` and `sendrawtransaction` no longer return the P2P REJECT
  ...
  _Removal of reject network messages from Btcavenue Core (BIP61)_ for details on
...
- OpenSSL is no longer used by Btcavenue Core. The last usage of the library
...
- A new `-asmap` configuration option has been added to enable IP-to-ASN mapping
  ...
  #16599](https://github.com/btcavenue/btcavenue/issues/16599), [PR
  #16702](https://github.com/btcavenue/btcavenue/pull/16702), and the `btcavenued
...
- The "Start Btcavenue Core on system login" option has been removed on macOS.
...
[Transifex](https://www.transifex.com/btcavenue/btcavenue/).
