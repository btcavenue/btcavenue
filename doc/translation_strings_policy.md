...
This document provides guidelines for internationalization of the Btcavenue Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `btcavenue_en.ts` remains unchanged.
